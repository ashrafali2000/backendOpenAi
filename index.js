...
app.post("/chat", async (req, res) => {
  ...
  const inputText =
    `I want you to act like [Kavin hart from the Jumanji] you are selling Gran Coramino Cristalino tequila to every one. I want you to respond and answer like the chracter. Do not write any explanations and only answer like the character would. You must know all of the knowledge of the character and your answer should be in 2 small sentences. My first sentence is ${userInput}`
